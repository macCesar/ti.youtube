Data set by `init` or `getUrlByVideoId` in `getVideoDetails`:
```json
{
  "url": {
    "small": "--LINK-TO-MP4-VIDEO-FILE--",
    "medium": "--LINK-TO-MP4-VIDEO-FILE--",
    "high": "--LINK-TO-MP4-VIDEO-FILE--",
    "best": "--LINK-TO-MP4-VIDEO-FILE--"
  },
  "videoId": "M5QY2_8704o",
